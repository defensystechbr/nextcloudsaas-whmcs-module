    ...
    <div class="nc-body">
        ...
        <div class="nc-section">
            ...
            <table>
                ...
                <tr>
                    <td>Admin:</td>
                    <td>{$collaboraAdmin}</td>
                </tr>
                <tr>
                    <td>Senha:</td>
                    <td>
                        {if $collaboraPass}
                            <span class="nc-secret">{$collaboraPass}</span>
                        {else}
        ...
        {* ================================================================ *}
        {* CREDENCIAIS - BANCO DE DADOS (MariaDB)                           *}
        {* ================================================================ *}
        <div class="nc-section">
            <h3>&#128451; Banco de Dados (MariaDB)</h3>
            <table>
                <tr>
                    <td>Host:</td>
                    <td><span class="nc-secret">{$dbHost}</span></td>
                </tr>
                <tr>
                    <td>Database:</td>
                    <td><span class="nc-secret">{$dbName}</span></td>
                </tr>
                <tr>
                    <td>Usuario:</td>
                    <td><span class="nc-secret">{$dbUser}</span></td>
                </tr>
                <tr>
                    <td>Senha:</td>
                    <td>
                        {if $dbPass}
                            <span class="nc-secret">{$dbPass}</span>
                        {else}
                            <em>Nao disponivel.</em>
                        {/if}
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        {if $dbRootPass}
                            <span class="nc-secret">{$dbRootPass}</span>
                        {else}
                            <em>Nao disponivel.</em>
                        {/if}
                    </td>
        ...
        <div class="nc-section">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        {if $turnSecret}
                            <span class="nc-secret">{$turnSecret}</span>
                        {else}
                            <em>Nao disponivel.</em>
                        {/if}
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        {if $turnAddress}
                            <span class="nc-secret">{$turnAddress}</span>
                        {else}
                            <em>Nao disponivel.</em>
                        {/if}
                    </td>
        ...
        <div class="nc-section">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        {if $signalingSecret}
                            <span class="nc-secret">{$signalingSecret}</span>
                        {else}
                            <em>Nao disponivel.</em>
                        {/if}
                    </td>
